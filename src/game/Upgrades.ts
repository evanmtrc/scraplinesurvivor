...
const damage=[0.2,0.3,0.45,0.65,0.9],rate=[0.12,0.18,0.27,0.38,0.5],count=[1,1,2,2,3];
export const WEAPON_MODS:WeaponMod[]=[
  ...
  {id:'scatter_payload',weapon:'scatter',name:'Packed shells',stat:'count',values:[2,3,4,6,8],unit:' pellets per blast',cap:3},
  ...
  {id:'mortar_charge',weapon:'mortar',name:'Seismic charge',stat:'damage',values:[0.25,0.4,0.6,0.85,1.2],unit:'% shell damage',cap:4},
